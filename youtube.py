...
def Api_connect():
    Api_Id="AIzaSyAVeY8f0m1IOovT1tbRLFGgYJymLRfAVg4"
...
client=pymongo.MongoClient("mongodb+srv://Teddy:gowthami@cluster0.uqvmkex.mongodb.net/?retryWrites=true&w=majority")
